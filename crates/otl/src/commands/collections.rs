...
/// Arguments for `otl collections create`.
#[derive(Debug, Args)]
...
/// Arguments for `otl collections update`.
#[derive(Debug, Args)]
#[command(after_long_help = "API contract:
...
/// Arguments for `otl collections delete`.
#[derive(Debug, Args)]
#[command(after_long_help = "API contracts:
  Without --archive this command uses collections.delete; with it,
  collections.archive.
