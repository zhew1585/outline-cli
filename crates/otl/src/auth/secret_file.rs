...
pub use crate::auth::file_guard::{
    directory_mode, ensure_dir, permissions, require_private_dir, Permissions,
};

use crate::auth::error::StoreError;
use crate::auth::file_guard::classify;
#[cfg(unix)]
use crate::auth::paths::FILE_MODE;
